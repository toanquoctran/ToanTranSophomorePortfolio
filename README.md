Toan Quoc Tran's portfolio in the sophomore year, which is adaptive to all kinds of devices, including but not limited to IPhones (small devices), IPads (medium devices), and Macs (large devices).
